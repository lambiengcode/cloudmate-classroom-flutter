...
class Constants {
  ...
  static const String baseUrl = "http://139.180.222.96:3000/";
  static const String imageUrl = "http://139.180.222.96:3000/" + 'api/up-load-file?id=';
  // Assets
  ...
  static const urlImageDefault =
      'https://github.com/lamb1engcode/flutter_mobile_cloudmate/blob/master/HiSchool!.png?raw=true';
  ...
  static final List<Map<String, String>> defaultClassImageUrls = [
    ...
    {
      'image': 'https://i.pinimg.com/564x/62/de/59/62de59126d9e5b2a72f7ab306ba08dd5.jpg',
      'blurHash':
          r'rGP;+eJC{Lv|:j-:xFNIAJ%hR*Z#xurqRPNHsqO?}v,pOAK6OFSes+r;xVL~S5tQV@K5t7ogbDwH|FR*Ki$$bcI;NIohof==slFMNdnPtRwcV@nh',
    },
    {
      'image': 'https://i.pinimg.com/564x/44/e7/9a/44e79a4fc1ae11b021629dcdfc68503d.jpg',
      'blurHash':
          r'r9D[S9%J0}#SmmEdAqxH-nyFT0I.s9wJaLslt7t70c$f}HEyKdnUw#brr?eTr=$+Sht2xtJBRiNY-WJ7J~sqVyxoV?VvxZItbGoaoMXAoIw[NHN1',
    },
    {
      'image': 'https://i.pinimg.com/564x/ba/ab/2b/baab2b85777e2754653d028ee0a30194.jpg',
      'blurHash':
